...
type TokenManager interface {
	GenerateToken(tokenData interface{}, ttl time.Duration) (string, error)
...
type tokenClaims struct {
	jwt.StandardClaims
	TokenData interface{} `json:"token_data"`
}
...
func (m *Manager) GenerateToken(tokenData interface{}, ttl time.Duration) (string, error) {
